...
export class StorageController {
  ...
  // @Post('insert-ndjson')
  // async insertNdjson() {
  //   return await this.storageService.insertNdjson('postgres', 'users');
  // }

  // @Post('postgres')
  // async createDatabasesDir() {
  //   return await this.storageService.createDatabasesDir();
  // }

  //   @Post('read')
  // async readDataFileNdjson() {
  //   return await this.storageService.readDataFileNdjson();
  // }
